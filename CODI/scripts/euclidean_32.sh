...
torchrun --nnodes 1 --master_port 22550 --nproc_per_node 4 train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name decoder-trajectory-euclidean-32long \
	--logging_dir "${SAVE_DIR}/logs/decoder-trajectory-euclidean-32long-logs" \
	--logging_steps 10 \
	...
	--trajectory_radius_threshold 10 \
