...
torchrun --nnodes 1 --master_port 22561 --nproc_per_node 4 train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name decoder-trajectory-euclidean-bigthrehold \
	--logging_dir "${SAVE_DIR}/logs/decoder-trajectory-euclidean-bigthrehold-logs" \
	--logging_steps 10 \
