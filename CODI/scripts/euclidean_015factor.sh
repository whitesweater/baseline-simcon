...
torchrun --nnodes 1 --master_port 22486 --nproc_per_node 4 train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name decoder-trajectory-euclidean-015 \
	--logging_dir "${SAVE_DIR}/logs/decoder-trajectory-euclidean-015-logs" \
	--logging_steps 10 \
