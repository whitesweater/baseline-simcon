#!/bin/bash
# =============================================================================
# Latent Sweep 测试脚本 - 第1组: codi, codi_sircl
# =============================================================================
...
mkdir -p "${RESULTS_DIR}"
LOG_FILE="${RESULTS_DIR}/latent_sweep_group1_${TIMESTAMP}.log"

log() {
    local msg="[$(date '+%Y-%m-%d %H:%M:%S')] [Group1] $1"
    echo "$msg"
    echo "$msg" >> "${LOG_FILE}"
}

log "============================================================================"
log "Latent Sweep 测试 - 第1组 (并行模式)"
