...
torchrun --nnodes 1 --master_port 25268 --nproc_per_node 4 train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name decoder-trajectory-euclidean-smallthrehold \
	--logging_dir "${SAVE_DIR}/logs/decoder-trajectory-euclidean-smallthrehold-logs" \
	--logging_steps 10 \
