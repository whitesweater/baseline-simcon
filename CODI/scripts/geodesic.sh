#!/bin/bash
# LLaMA 1B Training with Decoder + Geodesic Deviation
...
python train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name gsm8k_llama1b_latent_decoder-geodesic \
	--logging_dir "${SAVE_DIR}/geodesic-logs" \
	--logging_steps 10 \
	...
	--use_trajectory_action False \
	--use_trajectory_geodesic True \
	--trajectory_geodesic_loss_factor 0.1
