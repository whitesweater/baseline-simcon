...
MODEL_SPECS = {
    ...
    "qwen3_0p6b": {
        "dest_name": "Qwen3-0.6B-Base",
        "local_env": "CODI_QWEN3_0P6B_PATH",
        "modelscope_id": "Qwen/Qwen3-0.6B-Base",
...
DATASET_SPECS = {
    ...
    "commonsense": {"hf_id": "zen-E/CommonsenseQA-GPT4omini", "split": "validation"},
}
