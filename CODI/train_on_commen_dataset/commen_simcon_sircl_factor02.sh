#!/bin/bash
# 消融实验: trajectory_loss_factor = 0.2
...
torchrun --nnodes 1 --master_port 22620 --nproc_per_node 2 train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name commen_simcon_sircl_factor02 \
	--logging_dir "${SAVE_DIR}/logs/commen_simcon_sircl_factor02-logs" \
	--logging_steps 10 \
