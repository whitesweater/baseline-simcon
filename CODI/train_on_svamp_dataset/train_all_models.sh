...
test_model() {
    ...
    torchrun --nnodes 1 --master_port ${port} --nproc_per_node 4 test_multi_dataset.py \
...
# 测试6个模型
test_model "simcon_sircl" "${CHECKPOINTS[simcon_sircl]}" 1 6 23531
test_model "simcon_sircl_f005" "${CHECKPOINTS[simcon_sircl_f005]}" 2 6 23532
test_model "codi_sircl" "${CHECKPOINTS[codi_sircl]}" 3 6 23533
test_model "codi_sircl_f005" "${CHECKPOINTS[codi_sircl_f005]}" 4 6 23534
test_model "simcon" "${CHECKPOINTS[simcon]}" 5 6 23535
test_model "codi" "${CHECKPOINTS[codi]}" 6 6 23536
