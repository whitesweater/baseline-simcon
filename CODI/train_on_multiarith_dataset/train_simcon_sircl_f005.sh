#!/bin/bash
# =============================================================================
# MultiArith - sim-con+sircl 模型 (factor=0.05)
# use_decoder=True, use_trajectory=True, trajectory_loss_factor=0.05
# =============================================================================
...
echo "============================================================================"
echo "MultiArith - sim-con+sircl (decoder=True, trajectory=True, factor=0.05)"
echo "============================================================================"
