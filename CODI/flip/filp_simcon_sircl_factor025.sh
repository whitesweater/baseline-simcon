#!/bin/bash
# 消融实验: trajectory_loss_factor = 0.2 (flip 数据集)
...
python train.py \
	--output_dir "${SAVE_DIR}" \
	--expt_name filp_simcon_sircl_factor025 \
	--logging_dir "${SAVE_DIR}/logs/filp_simcon_sircl_factor025-logs" \
	--logging_steps 10 \
