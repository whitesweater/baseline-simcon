...
Use [scripts/ensure_easyconnect_container.sh](scripts/ensure_easyconnect_container.sh).
...
Run [scripts/check_easyconnect_proxy.sh](scripts/check_easyconnect_proxy.sh).
