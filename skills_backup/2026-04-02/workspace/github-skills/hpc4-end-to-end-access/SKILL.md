...
Prefer [../hpc4-docker-vpn/scripts/ensure_easyconnect_container.sh](../hpc4-docker-vpn/scripts/ensure_easyconnect_container.sh), then [../hpc4-docker-vpn/scripts/check_easyconnect_proxy.sh](../hpc4-docker-vpn/scripts/check_easyconnect_proxy.sh).

### Stage 2. HPC4 login through SOCKS5

The validated local login helper is [scripts/hpc4_login_via_vpn.sh](scripts/hpc4_login_via_vpn.sh).
...
Run [scripts/refresh_npu_pool_via_hpc4.sh](scripts/refresh_npu_pool_via_hpc4.sh).
...
Use [scripts/connect_npu_from_summary.sh](scripts/connect_npu_from_summary.sh) with the chosen 1-based index.
